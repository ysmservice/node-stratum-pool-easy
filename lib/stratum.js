 ...
 *  - eth_submitLogin(data(name, password))
 *  - eth_submitWork(data(nonce, powHash, mixDigest))
**/
        ...
        _this.emit('submit',
            {
                ...
                mixDigest  : message.params[0],
                version: (message.method === 'eth_submitWork') ? "v2" : "v1",
                workerName : _this.workerName,
                workerPass : _this.worker,
            },
