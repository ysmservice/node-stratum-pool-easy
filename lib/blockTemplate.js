...
**/
module.exports = {};
var BlockTemplate = module.exports.df = function BlockTemplate(jobId, rpcData, poolAddressScript, extraNoncePlaceholder, reward, txMessages, recipients){
...
var BlockTemplateEH = module.exports.eh = function BlockTemplateEH(
    jobId,
    rpcData,
    extraNoncePlaceholder,
    recipients,
